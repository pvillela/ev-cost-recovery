...
//!
//! `session::csv` is the sole caller. It settles an ambiguous wall time against `Conn_Duration`,
//! which is the only evidence a report carries about which of the two readings is meant.
