...
//! asking: five files chosen from pickers rather than given as positional arguments.
//!
...
fn main() -> eframe::Result<()> {
    ...
    eframe::run_native(
        ...
        Box::new(|cc| {
            ...
            //
            // 1.30, because egui's default body text is 13pt in a light-weight face, which is
            // thin enough on a pale panel to read as grey however black it actually is. Size is
            // the one lever that works on that without a font file: it thickens every stroke on
            // the screen at once.
