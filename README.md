...
Much, but not all, of this documentation pertains to software structure or electrical engineering concerns. Some portions are useful to end-users and administrators.
...
- [docs/session/Rough_kW_kVA_Table.xlsx](docs/session/Rough_kW_kVA_Table.xlsx) -- Spreadsheet comparing rough kW and kVA estimates per charger with the values resulting from the electrical engineering site model (see also [docs/session/site-model-marcus.md](docs/session/site-model-marcus.md)).
...
- [docs/session/site-model-marcus.md](docs/session/site-model-marcus.md) -- Electrical engineering model of an Evolute panel, transformer, and connected EV charging stations. Values are based on an Evolute 20-breaker panel and a Marcus AMTH75A1 transformer.
...
- [docs/session/transformer-glossary.md](docs/session/transformer-glossary.md) -- Glossary of electrical engineering terms related to transformers.
...
- [docs/green_button/README.md](docs/green_button/README.md) -- The Green Button ESPI XML feed, the peak values, and the generated workbook layout.
